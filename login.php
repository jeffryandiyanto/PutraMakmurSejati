...
<div class="container-fluid">
    <div class="row d-flex justify-content-center">
      <div class="col-lg-8 col-md-8 mt-4">
        <div class="card">
          <div class="card-body">
            <center class="h1 font-weight-bold mb-5">Login</center>
            ...
            <input value="Login" type="submit" name="submit" class="btn btn-block text-white mt-4 p-3" style="background-color:#BC0000"/>
            </form>
          </div>
        </div>
      </div>
